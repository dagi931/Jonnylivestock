            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <h1 className={`font-serif font-bold text-2xl sm:text-3xl mt-0.5 ${isDark ? 'text-[#F4E8D0]' : 'text-[#2A1A0D]'}`}>
                  Freshly Slaughtered Sheep Delivery Dashboard
                </h1>
          ...
          >
            {submitted ? (
              <div className="text-center py-8 space-y-4">
                ...
                <h2 className="font-serif font-bold text-xl">Fresh Sheep Order Placed!</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="flex items-center justify-between border-b pb-2.5" style={{ borderColor: isDark ? '#4A2C16' : '#E4D4BC' }}>
                  ...
                  <span className="text-[11px] opacity-70">Slaughtered Fresh at Aware</span>
                </div>
