              ...
              {!isAuthenticated && (
                <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-sm">
                  <div className="flex items-start sm:items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="text-[11px] sm:text-xs opacity-80">
                        {isAmharic
                          ? 'የስጋ ትዕዛዝዎን፣ ደረሰኝዎንና የማድረሻ ሁኔታዎን በቀላሉ ለመከታተል መለያ እንዲፈጥሩ ወይም እንዲገቡ እንመክራለን (ያለመለያም ማዘዝ ይችላሉ)።'
                          : 'To easily track your orders, receipts, and meat delivery status in real time, creating an account or signing in is recommended.'}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 w-full sm:w-auto shrink-0">
                    <button
                      type="button"
                      onClick={() => openAuthModal('register', isAmharic ? 'የበሬ ስጋ በኪሎ ትዕዛዝዎን በቀላሉ ለመከታተል መለያ እንዲፈጥሩ እንመክራለን።' : 'Creating an account is recommended to track your raw beef order.')}
                    ...
                    <button
                      type="button"
                      onClick={() => openAuthModal('login', isAmharic ? 'የበሬ ስጋ በኪሎ ትዕዛዝዎን በቀላሉ ለመከታተል እባክዎ ይግቡ።' : 'Sign in to easily track your raw beef order.')}
