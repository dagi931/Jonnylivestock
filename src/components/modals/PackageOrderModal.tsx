                  ...
                  {!isAuthenticated && (
                    <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-xs">
                      <div className="flex items-start sm:items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <div className="text-[11px] sm:text-xs opacity-80">
                            {isAmharic
                              ? 'የበዓል ጥቅል ትዕዛዝዎን፣ ደረሰኝዎንና የሁኔታ ክትትልዎን በቀላሉ ለማግኘት መለያ እንዲፈጥሩ ወይም እንዲገቡ እንመክራለን (ያለመለያም ማዘዝ ይችላሉ)።'
                              : 'To track your celebration packages, receipts, and live order status, creating an account or signing in is recommended.'}
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2 w-full sm:w-auto shrink-0">
                        <button
                          type="button"
                          onClick={() => openAuthModal('register', isAmharic ? `የበዓል ጥቅል "${packageName}" ትዕዛዝዎን በቀላሉ ለመከታተል መለያ እንዲፈጥሩ እንመክራለን።` : `Creating an account is recommended to track your order for "${packageName}".`)}
                        ...
                        <button
                          type="button"
                          onClick={() => openAuthModal('login', isAmharic ? `የበዓል ጥቅል "${packageName}" ትዕዛዝዎን በቀላሉ ለመከታተል እባክዎ ይግቡ።` : `Sign in to easily track your order for "${packageName}".`)}
