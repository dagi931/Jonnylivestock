...
export const LanguageToggle: React.FC = () => {
  ...
  return (
    <button
      ...
      type="button"
      className={`relative flex items-center justify-center gap-1.5 px-2.5 h-10 rounded-xl border text-xs font-bold transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C58A3A] shadow-xs cursor-pointer ${
        isDark
