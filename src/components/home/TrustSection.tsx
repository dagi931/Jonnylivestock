        ...
        <div className="grid grid-cols-4 gap-1.5 sm:gap-6">
          {features.map((feature, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`p-2 sm:p-6 rounded-xl sm:rounded-2xl border transition-all duration-200 flex flex-col items-center sm:items-start text-center sm:text-left justify-start ${
                  isDark
