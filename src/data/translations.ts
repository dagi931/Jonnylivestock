...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    howItWorks: {
      ...
      step1Title: 'Browse',
      step1Desc: 'Explore available sheep, goats, and cows in our updated catalog with real photos and exact weights.',
      step2Title: 'Choose',
    ...
    aboutPage: {
      ...
      point1Desc: 'Handpicked Horro & Menz sheep, Boer & Highland goats, and Boran, Fogera & Begait cattle.',
      ...
      sheepCardDesc: 'High-pasture Horro rams, thick-fleece Menz sheep, and fast-growing Bonga breeds with sound health and frames.',
      goatCardTitle: 'Goat Selection',
      goatCardDesc: 'Muscular Boer crosses and hardy Highland goats known for excellent meat yield and high feeding efficiency.',
      cowCardTitle: 'Cow & Cattle Selection',
      cowCardDesc: 'Prime Boran bulls, heavy Fogera cows, and tall Begait cattle ideal for holiday banquets, breeding, or meat.',
      ...
      trust4Desc: 'Precision cuts for Kitfo, Tre Kurt, Wot, Tibs, and Dulet prepared under strict sanitary standards.',
  ...
  am: {
    ...
    hero: {
      headlineLine1: 'የታመነ የቀንድ ከብትና የበግ እርባታ',
      headlineHighlight: 'ጆኒ ከብት እርባታ',
    ...
    aboutPage: {
      ...
      point1Desc: 'የሆሮና መንዝ በጎች፣ የቦየርና የደጋ ፍየሎች፣ እንዲሁም የቦረና፣ ፎገራና በጋይት ሰንጋዎች።',
      ...
      sheepCardDesc: 'የሆሮ ሙክት፣ የወፍራም ሱፍ መንዝ በጎችና በፍጥነት የሚያድጉ የቦንጋ ዝርያዎች።',
      goatCardTitle: 'የፍየሎች ምርጫ',
      goatCardDesc: 'ጥሩ የስጋ ምርት የሚሰጡ የቦየር ዝርያዎችና ብርቱ የደጋ ፍየሎች።',
      cowCardTitle: 'የከብቶችና ሰንጋዎች ምርጫ',
      cowCardDesc: 'ለበዓል ድግስና ለስጋ ንግድ የሚሆኑ የቦረና፣ የፎገራና የበጋይት ምርጥ ሰንጋዎች።',
      ...
      trust4Desc: 'ለክትፎ፣ ለጥሬ ቁርጥ፣ ለወጥ፣ ለጥብስና ለዱለት የሚሆን ስጋ በንጽህና ይዘጋጃል።',
